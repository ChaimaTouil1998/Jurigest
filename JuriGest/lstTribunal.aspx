<%@ Page Title="قائمة المحاكم بالجمهورية التونسية" Language="vb" AutoEventWireup="false" MasterPageFile="~/Vide.Master" CodeBehind="lstTribunal.aspx.vb" Inherits="JuriGest.lstTribunal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 text-right">
                        <h1 class="h3 mb-0 text-gray-800">قائمة المحاكم</h1>
                    </div>
                    ...
                    <div class="bg-white py-2 collapse-inner rounded" >
                         <div class="form-group text-right">
                                    <asp:TextBox ID="txtLibelle" class="form-control form-control-user" aria-describedby="emailHelp"
                                                placeholder="المحكمة..." runat="server"></asp:TextBox>
                         </div>
                       
                        <div class="text-right">
                     <asp:LinkButton ID="btnSave" Text="تثييت" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" runat="server" ></asp:LinkButton>
                    </div>
                        </div>
                </div>
            </li>
    ...
    <asp:Panel ID="Panel1" runat="server" BackColor="Window" Visible="false">
                <div class="row text-right">
                    ...
                    <div class="col">
                        <div class="form-group">
                            <asp:Label Text="المحكمة" ID="Label1" runat="server"></asp:Label>
   ...
   <asp:GridView ID="grdListe" runat="server" class="table table-bordered text-right" AutoGenerateColumns="False" DataKeyNames="Code" DataSourceID="sqlListe">
            <Columns>
                ...
                <asp:BoundField DataField="Libelle" HeaderText="المحكمة" SortExpression="Libelle" />
                <asp:TemplateField>
                <ItemTemplate>
    ...
    <div class="row">
                    ...
                    <asp:SqlDataSource ID="sqlListe" runat="server" ConnectionString="<%$ ConnectionStrings:JuriConnectionString %>" ProviderName="<%$ ConnectionStrings:JuriConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [Tribunal]"></asp:SqlDataSource>
