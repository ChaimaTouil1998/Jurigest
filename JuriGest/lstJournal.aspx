<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Vide.Master" CodeBehind="lstJournal.aspx.vb" Inherits="JuriGest.lstJournal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 text-right">
                        <h1 class="h3 mb-0 text-gray-800">قائمة الجرائد</h1>
                    </div>
                    ...
                    <div class="bg-white py-2 collapse-inner rounded" >
                         <div class="form-group text-right">
                                    <asp:TextBox ID="txtLibelle" class="form-control form-control-user" aria-describedby="emailHelp"
                                                placeholder="الجريدة..." runat="server"></asp:TextBox>
                         </div>
    ...
    <asp:Panel ID="Panel1" runat="server" BackColor="Window" Visible="false">
                <div class="row text-right">
                    ...
                    <div class="col">
                        <div class="form-group">
                            <asp:Label Text="الجريدة" ID="Label1" runat="server"></asp:Label>
   ...
   <asp:GridView ID="grdListe" runat="server" class="table table-bordered text-right" AutoGenerateColumns="False" DataKeyNames="Code" DataSourceID="sqlListe">
            <Columns>
                ...
                <asp:BoundField DataField="Libelle" HeaderText="الجريدة" SortExpression="Libelle" />
                <asp:TemplateField>
                <ItemTemplate>
    ...
    <div class="row">
                    ...
                    <asp:SqlDataSource ID="sqlListe" runat="server" ConnectionString="<%$ ConnectionStrings:JuriConnectionString %>" ProviderName="<%$ ConnectionStrings:JuriConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [journal]"></asp:SqlDataSource>
