...
Public Class PatriDos
    ...
    Private Sub grdDoc_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles grdDoc.RowCommand
        If (e.CommandName = "OpenLg") Then
            ...
            Response.Redirect("~\FichePatrimoine.aspx?Id=" & k)
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Response.Redirect("~\FichePatrimoine.aspx")
    End Sub

    Private Sub btnRepart_Click(sender As Object, e As EventArgs) Handles btnRepart.Click
