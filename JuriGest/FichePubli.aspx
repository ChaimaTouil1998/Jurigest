<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Standard.Master" CodeBehind="FichePubli.aspx.vb" Inherits="JuriGest.FichePubli" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="row text-right">
                    ...
                    <div class="col">
                     <div class="form-group">    
                        ...
                        <div class="form-group">
                         <asp:Label Text="الجريدة" ID="Label7" runat="server"></asp:Label>
                            ...
                            <asp:SqlDataSource ID="sqlTribunal" runat="server" ConnectionString="<%$ ConnectionStrings:JuriConnectionString %>" ProviderName="<%$ ConnectionStrings:JuriConnectionString.ProviderName %>" SelectCommand="SELECT [Code], [Libelle] FROM [journal]"></asp:SqlDataSource>
                        </div>
    <div class="row text-right">
     ...
     <div class="form-group">    
                                  ...
                                  <asp:TextBox ID="txtNumero" class="form-control form-control-user" aria-describedby="emailHelp"
      ...
      <div class="form-group">    
           ...
           <div class="form-group">    
                                  <asp:Label Text="نص الإشهار" ID="Label2" runat="server"></asp:Label>
  ...
  <div class="form-group">    
         <asp:Label  Text="نسخة من نص الإشهار" ID="Label3" runat="server" Visible ="false"></asp:Label>
    ...
    <Columns>
     ...
     <asp:SqlDataSource ID="sqlDoc" runat="server" ConnectionString="<%$ ConnectionStrings:JuriConnectionString %>" ProviderName="<%$ ConnectionStrings:JuriConnectionString.ProviderName %>" SelectCommand="SELECT [Chemin] FROM [dtlPubli] WHERE ([Id] = ?) and chemin <> ''">
         <SelectParameters>
