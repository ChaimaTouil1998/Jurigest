<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Standard.Master" CodeBehind="HeriteDos.aspx.vb" Inherits="JuriGest.HeriteDos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 text-right">
                        <h1 class="h3 mb-0 text-gray-800">قائمة الورثاء<asp:ScriptManager ID="ScriptManager1" runat="server">
                            </asp:ScriptManager>
                        </h1>
                    </div>
    ...
    <Columns>
     ...
     <asp:SqlDataSource ID="sqlDoc" runat="server" ConnectionString="<%$ ConnectionStrings:JuriConnectionString %>" ProviderName="<%$ ConnectionStrings:JuriConnectionString.ProviderName %>" SelectCommand="SELECT [Id], [Nom], [Identifiant] FROM [dtlherite] WHERE ([NumDOs] = ?)">
         <SelectParameters>
