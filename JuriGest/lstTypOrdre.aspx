<%@ Page Title="أنواع الأذون" Language="vb" AutoEventWireup="false" MasterPageFile="~/Vide.Master" CodeBehind="lstTypOrdre.aspx.vb" Inherits="JuriGest.lstTypOrdre" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 text-right">
                        <h1 class="h3 mb-0 text-gray-800">قائمة أنواع الأذون</h1>
                    </div>
    ...
    <asp:Panel ID="Panel1" runat="server" BackColor="Window" Visible="false">
                <div class="row text-right">
                    ...
                    <div class="col">
                        <div class="form-group">
                            <asp:Label Text="النوع" ID="Label1" runat="server"></asp:Label>
   ...
   <asp:GridView ID="grdListe" runat="server" class="table table-bordered text-right" AutoGenerateColumns="False" DataKeyNames="Code" DataSourceID="sqlListe">
            <Columns>
                ...
                <asp:BoundField DataField="Libelle" HeaderText="النوع" SortExpression="Libelle" />
                <asp:TemplateField>
                <ItemTemplate>
    ...
    <div class="row">
                    ...
                    <asp:SqlDataSource ID="sqlListe" runat="server" ConnectionString="<%$ ConnectionStrings:JuriConnectionString %>" ProviderName="<%$ ConnectionStrings:JuriConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [typordre]"></asp:SqlDataSource>
